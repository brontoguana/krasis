...
class TransformerLayer:
    ...
    def __init__(
        ...
        if self.is_moe:
            ...
            self.router_vl_bias = weights["gate"].get("vl_bias")
        ...
        self._router_vl_bias_f32 = (
            self.router_vl_bias.float()
            if self.is_moe and self.router_vl_bias is not None
            else None
        )
